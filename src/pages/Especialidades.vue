        ...
        <div class="max-w-7xl mx-auto px-6">
          ...
          <div v-for="letter in activeLetters" :key="letter" class="mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div v-for="especialidad in getSpecialtiesByLetter(letter)" :key="especialidad.id"
                ...
                <!-- Specialty Icon -->
                <div
                  class="h-40 bg-gradient-to-br from-teal-500 to-teal-600 flex items-center justify-center relative group">
